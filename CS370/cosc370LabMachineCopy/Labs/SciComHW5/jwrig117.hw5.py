...
# loop to evaluate the Cubic Spline for the elements
...
for Re in Re_array:
    ...
    # Re is an element from the RE_array
    # logy is the y-coordinate corresp. to log10(Re)
...
# loop to evaluate the Cubic Spline for the elements in the T_array
for temp in T_array:
    y = evalSpline(tData, mData, k, temp)
    print('{:6.1f}\t{:5.3f}'.format(temp, y))
    # temp is an element from T_array
