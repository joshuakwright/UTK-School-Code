...
#  as well.
#
#  Here I am approximating the second derivative at x=0.2 for the list of key value pairs as outlined in data9.
#  I am doing that by using by using a second-order accurate central finite difference approximation
#  and then using the values outputted using a step value of 0.2 and 0.1 to produce a value acccurate to 0.2**4
#  using the richardson extrapolation equation.
#  Joshua Wright HW 8
#
print("Problem 5.1.9\n=============")
#
...
#
h2 = h1 / 2.0
centralApprox2 = (-data9[x-h2]+data9[round(x+h2, decimals=1)]) / (2*h2)
#
# Now, apply Richardson Extrapolation to improve the approximation of f'(0.2)
# using centralApprox1 and centralApprox2
p = 2.0
richardsonExtrap = (2**2*centralApprox2-centralApprox1) / (2**2-1)
...
#
#  In this problem I am using polynomial interpolation, which involves finding the cubic polynomial that
#  represents the x and y data below and then using that function, computing the first and second derivatives
#  to approximate the actual derivatives of the function the x and y data points were drawn from an then using the
#  actual derivatives to compute the error of the interpolation.
#  Joshua Wright HW 8
#
print("\nProblem 5.1.11\n==============")
#
